...
(function (Dice) {
    ...
    function dieTypeToSides(t) {
        switch (t) {
            case 'boost': return Dice.Boost;
            case 'setback': return Dice.Setback;
            case 'ability': return Dice.Ability;
            case 'difficulty': return Dice.Difficulty;
            case 'proficiency': return Dice.Proficiency;
            case 'challenge': return Dice.Challenge;
            case 'force': return Dice.Force;
        }
    }
    class DiePool {
        constructor(dice) {
            this.dice = Object.assign(Object.assign({}, Dice.defaultDice), dice);
        }
        static build(skill, ability) {
            var dice = Object.assign({}, Dice.defaultDice);
            var i = 0;
...
function setTableDataInnerText(id, text) {
...
function dataNode_nearestNodeWithStatContainer(node) {
...
function buildDataNodeTree(root) {
